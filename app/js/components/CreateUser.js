...
class CreateUser extends Component {
  ...
  render() {
    ...
    let feedback = isValid ? 'Oraganization-name is available' : this.state.error || 'Oraganization-name must be 6 or more characters and cannot include @ or spaces.';
    ...
    return (
      <Grid>
        <Row>
          <Col xs={12}>
          <PageHeader>Register yourself <small>by{ this.props.account }</small></PageHeader>
          </Col>
        </Row>
        <Row>
          <Col xs={12}>
